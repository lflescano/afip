 ...
 * Web Service de Factura Electrónica V1 ("wsfev1") - R.G. N° 2.485 , para quienes emitan comprobantes "A", "B" y "C" sin detalle de ítem,
 * CAE y CAEA (solo para "A" y "B"). Reemplaza al anterior WSFE.
 * Factura electrónica AFIP, tanto CAE y CAEA (código de autorización electrónica anticipado, RG2926)
 * WSFEv1: factura electrónica A,B,C RG2485, 2485, 2757, 3067, 3571, 3668, 3689, 3749, 3779
 * 
 * @link http://www.afip.gob.ar/fe/documentos/manual_desarrollador_COMPG_v2_10.pdf WS Specification
 *
 * @author Ivan Muñoz
 * @package Dedalo\Afip\ws
 * @version 0.7
 **/

class Wsfev1 extends AfipWebService {
     ...
     * certain sales point and voucher type {@see WS Specification item 4.15} 
     *
    ...
    **/
     ...
     *
     * Asks to AFIP servers for complete information of voucher {@see WS Specification item 4.19}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for voucher types availables {@see WS Specification item 4.4}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for voucher concepts availables {@see WS Specification item 4.5}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for document types availables {@see WS Specification item 4.6}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for aliquot availables {@see WS Specification item 4.7}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for currencies availables {@see WS Specification item 4.8}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for voucher optional data available {@see WS Specification item 4.9}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for tax availables {@see WS Specification item 4.10}
     *
    ...
    **/
    ...
    /**
     * Asks to AFIP Servers for points of sales {@see WS Specification item 4.11}
     *
     * @return array All points of sales
    **/
    public function GetPointsSales()
    {
    ...
    /**
     *
     * Asks to AFIP servers for currency quote {@see WS Specification item 4.12}
     *
     * @param int $monId Currency Id
     * @return array|null
    **/
    public function GetCurrencyQuote($monId)
    {
        $req = array(
            'MonId' => $monId
        );
        ...
        try {
            $result = $this->ExecuteRequest('FEParamGetCotizacion', $req);
        } catch (Exception $e) {
            if ($e->getCode() == 602) 
                return NULL;
            else
    ...
    /**
     * Asks to web service for servers status {@see WS Specification item 4.14}
     *
